...
//! - MIDI-CI discovery, capability negotiation, Property Exchange, and
//!   Profile Configuration message layers.
...
pub use property::{
    header_field, header_field_num, ProfileConfigMessage, PropertyDataSetAssembler,
